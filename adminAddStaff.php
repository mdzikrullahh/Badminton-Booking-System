              ...
              if (isset($_POST['submit'])) {
                ...
                if (empty($errors)){
                    ...
                    $sql = "INSERT INTO user(user_name, user_email, user_pass, user_phone, user_age, role_id, create_at, token) 
                            VALUES ('$name', '$email','$password', '$phone','$age', '$role', NOW(), '$newtoken')";
        
                    $result = mysqli_query($conn, $sql);
        
                    if($result){
                        echo "<script>alert('Staff account has been registered!');</script>";
...
<section class="pt-7 px-7 md:px-20 w-full">
    <h2 class="text-3xl font-bold mb-4 text-white">Add Staff</h2>
                ...
                <form action="" method="POST">
                    ...
                    <div class="flex flex-col md:flex-row gap-0 md:gap-4">
                      <div class="mt-2 relative w-full">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          ...
                          <input type="text" name="name" class="form-control p-1 w-full" placeholder="Name" value="">
                        </div>
                      </div>
                      <div class="mt-2 relative w-full">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          <label class="bg-white absolute left-3 top-0 text-xs px-1" for="">Email</label>
                          <input type="text" name="email" class="form-control p-1 w-full" placeholder="Email" value="">
                        </div>
                      </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-0 md:gap-4">
                      <div class="mt-2 relative w-full">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          ...
                          <input type="text" name="age" class="form-control p-1 w-full" placeholder="Age" value="">
                        </div>
                      </div>
                      <div class="mt-2 relative w-full">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          <label class="bg-white absolute left-3 top-0 text-xs px-1" for="">Phone Number</label>
                          <input type="text" name="phone" class="form-control p-1 w-full" placeholder="Phone Number" value="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="mt-2 relative w-full" style=" padding-top:5px">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          ...
                          <input type="password" name="password" class="form-control p-1 w-full" placeholder="Password" value="">
                        </div>
                    </div>
                    <div class="mt-2 relative w-full">
                        <div class="border-2 border-gray-400 p-1 rounded-lg mt-2">
                          <label class="bg-white absolute left-3 top-0 text-xs px-1" for="">Role</label>
                          <select name="role" class="form-control p-1 w-full">
                            <?php
                    ...
                    <!-- <input type="text" name="token" class="form-control p-1 w-full" placeholder="token" value=""> -->
                    <br><br>
                    ...
                    <button name="back" class="px-4 py-1 rounded-lg bg-gray-300">Back</button>    
                      <button class="px-4 py-1 rounded-lg bg-dtargreen" name="submit" >Submit</button>
                    </div>
                    </form>
