          ...
          if ($token === $dbToken) {
              ...
              if (isset($_POST['submit'])) {
                ...
                if ($result) {
                    ...
                    if ($result2) {
                        $sql = "UPDATE booking SET booking_history = 'In Process' , update_at = NOW() WHERE booking_id = '$booking_id'";
                        $result3 = mysqli_query($conn, $sql);
            
                        if ($result3) {
                            echo "<script>alert('Your booking is confirmed. Have a great time!');</script>";
...
<div class="min-w-screen min-h-screen bg-gray-200 flex items-center justify-center px-5 pb-10">
    <div class="w-full mx-auto rounded-lg bg-white shadow-lg p-5 text-gray-700" style="max-width: 600px">
        ...
        <div class="mb-10">
            <h1 class="text-center font-bold text-xl" style="font-size:25px">Pay at Counter</h1><br>
            <h1 class="text-center font-bold text-xl" style="color:red">**Please ensure that your booking is paid at least 1 hour prior to the scheduled start time. Failure to complete the payment within the specified time will result in automatic cancellation of your booking.</h1>
        </div>

            <h1 class="text-center font-semibold text-xl">Total : RM <?php echo $_SESSION['selected_booking_price'] ?></h1>
          <form method="POST">
            <div>
